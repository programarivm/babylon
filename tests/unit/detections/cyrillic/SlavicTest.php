    ...
    public function belData()
    {
        return [
            [
                ...
                таму і стравы, здавалася, зробленыя з грубага цяля'
            ],
        ];
    }
    ...
    public function bulData()
    {
        return [
            [
                ...
                полета; сенките им бродят денем и нощем и чакат онези'
            ],
        ];
    }
    ...
    public function hrvData()
    {
        return [
            [
                ...
                га испод трепавица као свежина бистра извора разгаљиваху'
            ],
        ];
    }
    ...
    public function rusData()
    {
        return [
            [
                ...
                постель, а по воскресеньям—церковь.'
            ],
        ];
    }
